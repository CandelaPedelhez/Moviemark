...
import styles from './SubmitGroceries.module.css';
            ...
            <div className={styles.page}>
                <div>
                    ...
                    <h1 className={styles.title}>Add grocerie</h1>
                        ...
                        <input className={styles.input}
                        value={input.typeGrocerie} type='text' name='typeGrocerie' placeholder="Type Grocerie" onChange={e=>handleChange(e)} required>
                        </input>
                        <input className={styles.input}
