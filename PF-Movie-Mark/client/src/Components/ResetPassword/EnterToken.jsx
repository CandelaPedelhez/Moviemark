  ...
  return (
    <div className={styles.page}>
      <form className={styles.form} onSubmit={(e) => handleSubmitToken(e)}>
        ...
        token.id.trim() === "" ||
        token.password === "" ? (
          <button disabled className={styles.buttondis} type="submit">
            Send
          </button>
        ) : (
        ...
        {invalidToken.bool === true ? (
          <p className={styles.errors}>Invalid Token</p>
        ) : (
          <></>
        )}
        {done === true ? (
          <p className={styles.success}>Password changed. You can login now</p>
        ) : (
          <></>
        )}
      </form>
